...
A collection of usefull functions for getting subimages of lower dimension, e.g. a slice or a profile from a 3D image.
...
calculated user defined interpolation. The interplation of 'nearest', 'linear' and 'spline' with order from 0 to 5 are available.
